...
const ProductTableList = () => {
  ...
  const [rows, setRows] = React.useState<ProductType[]>(filteredAndSortedProducts || []);
  ...
  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
    const filteredRows: ProductType[] = filteredAndSortedProducts.filter((row) => {
  ...
  const handleRequestSort = (event: React.MouseEvent<unknown>, property: React.SetStateAction<string>) => {
